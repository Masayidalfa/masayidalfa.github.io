    ...
    <div>
      ...
      <nav className="w-full flex justify-between items-center p-10 h-[100px] bg-transparent">
        ...
        <ul className="flex space-x-6">
          <li className="relative text-lg font-medium cursor-pointer hover:text-cyan-400">
            Home
      ...
      <section className="flex justify-center items-center h-[calc(100vh-100px)] text-center">
        <div className="text-white">
          ...
          <p className="text-lg my-4">This is your introductory text here</p>
          <button className="px-6 py-2 bg-cyan-400 text-black font-semibold text-lg rounded-lg transition hover:bg-cyan-600">
            Contact Me
          </button>
        </div>
      </section>
